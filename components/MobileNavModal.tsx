      ...
      <div className="bg-white w-full h-full max-w-screen-lg mx-auto py-4 px-7  ">
        <div className="flex items-center justify-between">
          <Link className="active:scale-95 transition-transform" href="/">
            <SiNike className="hover:opacity-70 " size={50} fill="#1d1d1f" />
          </Link>
          ...
          <div className="flex items-center  ">
            ...
            <div
              ...
              className="w-8 h-8 p-1 cursor-pointer rounded-full flex justify-center items-center active:scale-95 transition-transform hover:bg-[#1d1d1f]/10 "
            >
